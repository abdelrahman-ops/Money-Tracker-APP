  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <nav className="fixed bottom-0 left-0 right-0 safe-bottom z-50 px-5 pb-4 pt-1.5 pointer-events-none">
        <div className="relative max-w-lg mx-auto flex items-center justify-between bg-[#1a1a1e] dark:bg-[#2a2a2e] rounded-[22px] px-3 py-1.5 pointer-events-auto shadow-xl shadow-black/25">
          {navItems.map((item) => {
            if (item.isFab) {
              return (
                <button
